...
$webmasterEmailAddress = 'christian@svampe.dk';                    // If you set the above to TRUE, enter the appropriate email address on this line.
$emailFromAddress = 'christian@svampe.dk';                               // Sets who the error message will show as the sender.
        ...
        switch(strtolower($name)) {
            ...
            case "row":
				...
				if(isset($this->currentData[$this->currentRecord])) {
					//Fix for identical record ids / mod ids due to an FM bug which returns 0.0 for all entries in -scriptnames
					$i =1;
